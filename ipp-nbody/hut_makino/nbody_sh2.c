              // Time-stamp: <2013-12-01 14:38:00 piet>
             //================================================================
            //                                                                |
           //           /__----__                         ........            |
          //       .           \                     ....:        :.          |
 ...
 *=============================================================================
 *
 *  nbody_sh2.C:  an N-body integrator with a shared but variable time step
 ...
 *                
 *  note: in the first version, all functions are included in one file,
 *        without any use of a special library or header files.
 *
 *  note: in this second version, code has been parallelized using OpenMP.
 ...
 *
 *            (nbody_sh2 < data.in > data.out) >& data.err
 *
 ...
 *_____________________________________________________________________________
 *
 *   version 2: Dec 2013  Piet Hut, Jun Makino, Andrew Edwards, Mike Gruesen
 *_____________________________________________________________________________
 */
...
int main(int argc, char *argv[])
{
    ...
    int time = (endTime.tv_sec * 1000000 + endTime.tv_usec) - (startTime.tv_sec *     1000000 + startTime.tv_usec);
    cerr << "Time Spent (in mS): " << time << endl;
    double timeSeconds = (time / 1000000);
    cerr << "Time Spent (in S) : " << timeSeconds << endl;
